...
CREATE TABLE employees (
  ...
  CONSTRAINT fk_managers FOREIGN KEY (managers_id) REFERENCES employees(id) ON DELETE CASCADE,
  CONSTRAINT fk_managers_name FOREIGN KEY (manager) REFERENCES employees(last_name) ON DELETE SET NULL
);
